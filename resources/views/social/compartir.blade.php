...
<div class="wrapper">
    ...
    <div class="compartir-form custom-form">
        <form action="/social" method="POST" id="compartir-form">
            ...
            <div class="mb-3">
                ...
                <small id="helpId" class="text-muted help-text">Escribe la pregunta que quieras ingresar en la Trivia</small>
            </div>
            <div class="mb-3">
                ...
                <small id="helpId" class="text-muted help-text">Asegúrate de chequear que la información sea correcta</small>
            </div>
            <div class="mb-3">
              ...
              <small id="helpId" class="text-muted help-text">1era respuesta incorrecta</small>
            </div>
            <div class="mb-3">
                ...
                <small id="helpId" class="text-muted help-text">2da respuesta incorrecta</small>
              </div>
              <div class="mb-3">
                ...
                <small id="helpId" class="text-muted help-text">3ra respuesta incorrecta</small>
              </div>
